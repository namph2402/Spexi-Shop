...
@section('content')
    ...
    <div class="container-fluid container-item pt-4">
        <h3 class="section-title position-relative text-uppercase mx-xl-5 mb-4 test"><span class="bg-secondary pr-3">Các sản
                phẩm</span></h3>
                    ...
                    <a class="d-block text-decoration-none cate-list" href="{{ $c->full_path }}">
                        <div class="cat-item d-flex align-items-center mb-4 cate-item">
                            <div class="overflow-hidden cate-img">
                                <img class="img-fluid" data-src="{{ $c->image }}" src="{{ $c->image }}"
                                    alt="{{ $c->name }}">
                            </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 pb-1 product wow fadeInUp" data-wow-delay="0.1s">
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    <img class="img-fluid w-100" data-src="{{ $p->image }}" src="{{ $p->image }}"
                                        alt="{{ $p->name }}">
                                </div>
                    ...
                    @if (count($promotions) == 1)
                        <div class="col-md-12 promotion-index">
                            <div class="product-offer mb-30">
                                <img class="img-fluid" data-src="{{ $p->image }}" src="{{ $p->image }}"
                                    alt=""{{ $p->name }}>
...
@if (count($posts))
<div class="container-fluid container-item pt-4 pb-3">
    <a href="/posts" class="section-title position-relative text-uppercase mx-xl-5 mb-4 link-title test"
        style="font-size:1.75rem">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 pb-1 product wow fadeInUp" data-wow-delay="0.1s">
                    <div class="product-item bg-light mb-4">
                        <div class="product-img position-relative overflow-hidden post-img-new">
                            <img class="img-fluid w-100 post-img-index" data-src="{{ $p->image }}"
                                src="{{ $p->image }}" alt="{{ $p->name }}"
                        ...
                        <div class="product-text text-center py-3">
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-2"
                                style="padding: 0 10px; font-size: 15px">
                                <div>
                                    <i class="fas fa-user"
                                        style="margin-right: 5px"></i>{{ $p->article->author_name }}
                                </div>
                                <div>
                                    <i class="fas fa-comment"
                                        style="margin-right: 5px"></i>{{ count($p->comments) }}
                                </div>
                            </div>
                        </div>
                    </div>
