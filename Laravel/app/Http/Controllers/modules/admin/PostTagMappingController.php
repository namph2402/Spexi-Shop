...
class PostTagMappingController extends RestController
{
    public function __construct(PostTagMappingRepositoryInterface $repository)
    {
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!($model instanceof PostTagMapping)) {
            return $this->errorNotFound();
        }
